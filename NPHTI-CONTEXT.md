...
- Build remaining pages in Bright Geometric: the four Training subpages (done: Mid-Year Meetup, Annual Workshops, Webinars, Training Archive), the single Training Resources page (sections: Learn about Hypnosis, From our Faculty, NPHTI Listserv, Other Hypnosis Training, FAQ — Find a Provider is an external link, not a new page), plus Contact and Donate. (Leadership and About are done.)
